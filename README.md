...
<br><br>
## 보완점
* 예약하기 기능을 대여시간 및 반납시간 등 시간 단위로 구현하지 못한 점
* 예약 취소 시, 결제 취소도 함께 이러우질 수 있도록 구현하지 못한 점
* 대여지점 선택 시, 지도 API와 DB를 연동하여 현재 사용 가능한 차량 정보를 확인할 수 있다면 사용자에게 더 편리한 서비스를 제공 가능
